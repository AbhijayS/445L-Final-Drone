...
GCC_FLAGS =  -nostartfiles -ffreestanding -ggdb -std=c99 -O0
GCC_FLAGS += -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mapcs-frame -mfloat-abi=softfp
GCC_FLAGS += -T ld/TM4C123GH6PM.ld -e Reset_Handler
